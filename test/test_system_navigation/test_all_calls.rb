...
class TestSystemNavigationAllCalls < Minitest::Test
  ...
  def test_all_calls_on_from_200e
    test_class = Class.new do
      def test_all_calls_on_from_200e
        200e-2
      end

      def test_all_calls_on_from_20_float
        2.0
      end
    ...
    expected = [
      test_class.instance_method(:test_all_calls_on_from_200e),
      test_class.instance_method(:test_all_calls_on_from_20_float),
      test_class.instance_method(:test_all_calls_on_from_200E,)
    ]

    assert_equal expected, @sn.all_calls(on: 200e-2, from: test_class)
  end
  ...
  def test_all_calls_on_from_empty_hash
    test_class = Class.new do
      def test_all_calls_on_from_empty_hash
        {}
      end
    ...
    expected = [
      test_class.instance_method(:test_all_calls_on_from_empty_hash)
    ]

    assert_equal expected, @sn.all_calls(on: {}, from: test_class)
  end
  ...
  def test_all_calls_on_from_empty_array
    test_class = Class.new do
      def test_all_calls_on_from_empty_array
        []
      end
    ...
    expected = [
      test_class.instance_method(:test_all_calls_on_from_empty_array)
    ]
